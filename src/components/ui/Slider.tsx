    ...
    <div>
      {label && (
        <div className="flex justify-between items-center mb-1">
          <span className="text-[8px] text-[#4a6385] tracking-widest font-bold uppercase">{label}</span>
      ...
      <input
        ...
        className="w-full h-1 bg-[#1e3050] rounded-full appearance-none cursor-pointer
